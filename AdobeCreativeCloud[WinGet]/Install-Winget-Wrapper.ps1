<#
.SYNOPSIS
    Installs Adobe.CreativeCloud

.DESCRIPTION
   Winget PowerShell script to install Adobe.CreativeCloud via the Company Portal
...
$productName    		= "Adobe.CreativeCloud"   #--------------------------------------------------------# Application name for logfile
