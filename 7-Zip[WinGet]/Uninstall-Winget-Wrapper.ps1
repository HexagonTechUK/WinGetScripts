...
.DESCRIPTION
   Winget PowerShell script to uninstall 7Zip via the Company Portal
...
$productName    		= "7zip.7zip"   #--------------------------------------------------------# Application name for logfile
$ProgramName 			= "7zip.7zip"   #--------------------------------------------------------# Deployment type: Install, Upgrade, Removal
