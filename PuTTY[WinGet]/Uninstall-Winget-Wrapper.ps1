...
.DESCRIPTION
   Winget PowerShell script to uninstall PuTTY via the Company Portal
...
$productName    		= "PuTTY"   #-----------------------------------------------# Application name for logfile
$ProgramName 			= "PuTTY.PuTTY"   #---------------------------------------------# Deployment type: Install, Upgrade, Removal
