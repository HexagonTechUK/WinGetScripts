<#
.SYNOPSIS
    Uninstalls Google Chrome Beta

.DESCRIPTION
   Winget PowerShell script to uninstall Google Chrome Beta via the Company Portal
...
$productName    		= "GoogleChromeBeta"   #-----------------------------------------------# Application name for logfile
$ProgramName 			= "Google.Chrome.Beta"   #---------------------------------------------# Deployment type: Install, Upgrade, Removal
