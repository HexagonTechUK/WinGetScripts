<#
.SYNOPSIS
    Uninstalls Oracle.VirtualBox

.DESCRIPTION
   Winget PowerShell script to uninstall Oracle.VirtualBox via the Company Portal
...
$productName    		= "OracleVirtualBox"   #-----------------------------------------------# Application name for logfile
$ProgramName 			= "Oracle.VirtualBox"   #----------------------------# Deployment type: Install, Upgrade, Removal
