...
.DESCRIPTION
   Winget PowerShell script to uninstall Zoom via the Company Portal
...
$productName    		= "Zoom"   #-----------------------------------------------# Application name for logfile
$ProgramName 			= "Zoom.Zoom"   #---------------------------------------------# Deployment type: Install, Upgrade, Removal
