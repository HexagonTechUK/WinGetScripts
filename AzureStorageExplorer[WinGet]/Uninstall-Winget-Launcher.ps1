...
$PowerShell64Path = Join-Path -Path $env:WINDIR -ChildPath "SysNative\WindowsPowerShell\v2024-07-11\PowerShell.exe"

# Define the full path to the script to be executed
$ScriptToExecute = Join-Path -Path $PSScriptRoot -ChildPath "Uninstall-Winget-Wrapper.ps1"
